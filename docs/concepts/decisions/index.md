...
Software development involves continuous decision-making.
...
A decision represents a choice worth preserving because it may matter to future work.
...
This relationship keeps the reasoning behind an implementation connected to the work it affects.
...
A decision can be associated with a session when the timing of the decision provides useful context.
...
Unlike a task, a decision does not move through states such as pending or completed. Once recorded, it represents a choice made at a particular point in the project's evolution.
