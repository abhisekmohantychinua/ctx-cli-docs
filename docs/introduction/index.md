...
CTX CLI keeps that context with the project: the information that explains what is happening, what has already happened, and why.
...
Developers and AI agents can ask CTX for the context that matters. Simple views support everyday work, and the query system supports detailed retrieval.
...
A developer can answer, "Where did I leave this project?" An AI agent can answer, "What is the current task, what has already been tried, what decisions were made, and what is still unresolved?".
